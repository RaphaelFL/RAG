...
public class ChatOrchestratorServiceTests
{
        ...
        CapturingChatSessionStore? sessionStore = null)
    {
        ...
        return new ChatOrchestratorService(
            ...
            new ChatRequestTemplateResolver(templates, detector, auditLogger ?? new CapturingSecurityAuditLogger()),
            new ChatEvidenceSelector(),
            new ChatStreamingSegmenter(),
            new ChatCompletionCacheKeyFactory(),
